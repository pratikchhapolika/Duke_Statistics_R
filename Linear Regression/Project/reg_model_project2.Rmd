...
We began this analysis with 32 variables that seemed to provide promise that we could build a robust model to predict the `audience_score` reliably.  However, as the data was examined and the variables evaluated and modified to meet the needs of the research question, our final data set was limited to one response variable and 7 explanatory variables.  Our model selection determined that the best performing model was the original full model that had the highest adjusted R^2 value.
