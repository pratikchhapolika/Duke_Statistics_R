...
library(car)#used for ceres plot - normality assumption
...
While working on this project I learned about other packages that provide useful tools understanding linear regression.  They are provided below should a reader want to delve more deeply into this topic.
