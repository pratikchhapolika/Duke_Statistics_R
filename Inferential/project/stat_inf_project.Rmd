...
1. **Independence**: Sampled observations must be independent:
   ...
   + While the GSS data is aummed random, the potential sources of bias are:
...
We now know that more people attend religious services than thos that chose not to.
```{r reduceFactorCnt2}
...
From this plot it appears  there is a consistent concensus on space exploration spending regardless of religious service attendenace.  Let's find out if what appears to be independent really is independent!
...
By rejecting the null hypothesis $H_{0}$, test results provides strong evidence suggesting that the frequency of religious services and support for space exploration are dependent or have some association.  Recall that this is an analysis of observational data so no causal connections can be made.
